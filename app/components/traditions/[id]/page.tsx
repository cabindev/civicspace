  ...
  return (
    <div className="bg-gray-100 min-h-screen pt-24">
     <div className="flex justify-center items-center my-4">
          <Link href="/components/traditions" className="inline-block">
            <div className="badge badge-success text-white gap-2 badge-lg p-4 text-lg hover:bg-green-400 transition-colors duration-300">
              ดูงานบุญประเพณีทั้งหมด
            </div>
          </Link>
        </div>
            ...
            <div className="p-6">
              ...
              <div className="flex flex-col md:flex-row md:space-x-4">
                ...
                {tradition.policyFileUrl && (
                  <a href={tradition.policyFileUrl} download className="flex items-center bg-blue-100 text-blue-700 px-4 py-2 rounded-full hover:bg-blue-200 transition duration-300">
