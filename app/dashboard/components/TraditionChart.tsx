...
export default function TraditionChart({ data }: TraditionChartProps) {
  ...
  const options: Highcharts.Options = {
    ...
    title: { 
      text: 'Tradition Distribution by Category',
      align: 'left',
      style: {
        fontSize: '18px',
        fontWeight: '600',
    ...
    subtitle: {
      text: 'การกระจายของประเพณีตามประเภท',
      align: 'left',
      style: {
        fontSize: '12px',
        fontWeight: '300',
        ...
        return `
          <div style="padding: 8px; text-align: center;">
            ...
            <div style="color: #374151; margin-bottom: 4px;">
              <strong style="color: #10B981;">จำนวน:</strong> ${this.y} ประเพณี
            </div>
      ...
      <div className="card-body p-6">
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-sm font-semibold text-green-800">Cultural Traditions</h3>
              <p className="text-xs text-green-600 font-light">มรดกทางวัฒนธรรม</p>
            </div>
          </div>
          <div className="text-right">
            ...
            <div className="text-xs text-green-500 font-light">Total Traditions</div>
          </div>
        </div>
