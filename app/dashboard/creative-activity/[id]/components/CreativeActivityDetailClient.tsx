// app/dashboard/creative-activity/[id]/components/CreativeActivityDetailClient.tsx
'use client'
...
interface CreativeActivityDetailClientProps {
        ...
        <div className="space-y-16">
          ...
          <section className="space-y-12">
            <div>
              ...
              <p className="text-gray-700 leading-relaxed font-light text-lg whitespace-pre-line">{activity.description}</p>
            </div>
            
            <div>
              <h3 className="text-xl font-normal mb-6 text-gray-900">สรุปเนื้อหาการดำเนินงาน</h3>
              <p className="text-gray-700 leading-relaxed font-light text-lg whitespace-pre-line">{activity.summary}</p>
            </div>
            
            {activity.results && (
              <div>
                <h3 className="text-xl font-normal mb-6 text-gray-900">ผลลัพธ์</h3>
                <p className="text-gray-700 leading-relaxed font-light text-lg whitespace-pre-line">{activity.results}</p>
              </div>
            )}
          </section>
